...
首先安装python，个人建议直接安装anaconda或者miniconda，上一小节已经说过了，所以到这里的话应该已经安装过了。
...
注意根据[conda-forge Tips & tricks](https://conda-forge.org/docs/user/tipsandtricks.html#how-to-fix-it) 的说明，conda-forge和conda并不完全兼容，因此有时候，**需要将前后顺序钉死，conda-forge在前**，这样才能避免出现安装错误，比如安装常用gis库 geopandas时，就必须得这么做，否则很可能报错。
